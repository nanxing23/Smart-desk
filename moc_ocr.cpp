...
QT_MOC_LITERAL(1, 4, 12), // "ocrReadyData"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 13), // "readyReadData"
QT_MOC_LITERAL(4, 32, 13), // "replyFinished"
QT_MOC_LITERAL(5, 46, 16) // "readyToDetection"

    },
    "Ocr\0ocrReadyData\0\0readyReadData\0"
    "replyFinished\0readyToDetection"
};
...
void Ocr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ocrReadyData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->readyReadData(); break;
        case 2: _t->replyFinished(); break;
        case 3: _t->readyToDetection((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->readyToDetection((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Ocr::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Ocr::ocrReadyData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Ocr::ocrReadyData(QString _t1)
{
