...
class Asryin : public QWidget
{
    Q_OBJECT

public:
    Asryin(QWidget *parent = nullptr);
    ~Asryin();
...
private:
    ...
    const QString api_key = "FpvuSGvwB2BllW6MDL2IoSWF";

    /* 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx" */
    const QString secret_key = "fZcjcimHciqJhTAkTi5IhXGclyw8zFSO";
